...
(n.prototype._toJSONG = function() {
	...
	(n.prototype.subscribe = n.prototype.forEach = function(t, o, e) {
		...
		switch (typeof s) {
			case 'function':
				return {
					dispose: function() {
						n._closed || ((n._closed = !0), s());
					}
				};
			case 'object':
				return {
					dispose: function() {
						n._closed || ((n._closed = !0), null !== s && s.dispose());
					}
				};
			default:
				return {
	...
	(n.prototype.then = function(t, o) {
		...
		return (
			e._promise ||
				(e._promise = new Promise(function(t, o) {
					var n = !1,
						r = [];
					e.subscribe(
						function(t) {
...
function bt(r, t, e) {
	...
	return function(r, t, e, s, n, h, i) {
		...
		l.criticalError
			? (e.onError(l.criticalErreturnror), null)
			: c
