...
export default class TimeoutTransitionGroupChild extends Component{
	...
	transition(i, t) {
		...
		if (!this.isMounted() || !n) return void ('function' == typeof t && t());
		var s = this,
			o = this.props.name + '-' + i,
			r = o + '-active',
			...
			m = function() {
				n.classList.remove(o),
					...
					('enter' !== i && 'appear' !== i) || !s.props.afterTransitionEnter
						? 'leave' === i && s.props.afterTransitionLeave && s.props.afterTransitionLeave(n)
						: s.props.afterTransitionEnter(n),
					'function' == typeof t && t();
			};
		e()
			? 'enter' === i || 'appear' === i
