...
export default class SiteError extends Component{
  ...
  render() {
    return React.createElement("div", null, React.createElement("div", {
      ...
      className: "seHeader"
      }, this.context.formatString(i.header)), React.createElement("p", null, this.context.formatString(i.bodyCopy), "  "), React.createElement("p", null, this.context.formatString(i.bodyCopy2), " "), React.createElement("div", {
